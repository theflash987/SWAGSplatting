...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int):
        ...
        # Semantic
        self.proj = nn.Linear(768, 32).to("cuda")
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        # Initialise semantic feature
        self._semantic_feature = nn.Parameter(torch.randn((fused_point_cloud.shape[0], 32), device="cuda") * 0.01)
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._semantic_feature], 'lr': training_args.semantic_lr, "name": "semantic"}
        ]
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest,new_opacities, new_scaling, new_rotation, new_semantic):
        ...
        self._scaling = optimizable_tensors["scaling"]
        self._rotation = optimizable_tensors["rotation"]
        self._semantic_feature = optimizable_tensors["semantic"]
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        new_semantic = self._semantic_feature[selected_pts_mask].repeat(N, 1)
    ...
    def get_semantic_feature(self, visibility_filter=None):
        if visibility_filter is None:
            return self._semantic_feature
        return self._semantic_feature[visibility_filter]
